...
def create_env(env_kwargs={}):
    data_df = pd.read_csv("data/clean/ETHday.csv")
...
ray.init()
checkpoint_path = 'model/discard/rainbow_eth/checkpoint_004500/checkpoint-4500'
# '/home/sean/ray_results/rainbow_eth/checkpoint_004500/checkpoint-4500'
...
#%%
result_plt(title='dqn_Rainbow_eth', time1='2019-12-31', time2=None)
...
action_result(title='rainbow_eth2')